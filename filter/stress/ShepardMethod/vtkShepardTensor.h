...
=========================================================================*/
// .NAME vtkShepardTensor - sample unstructured points onto structured points using the method of Shepard
// .SECTION Description
// vtkShepardTensor is a filter used to visualize unstructured point data using
...
#ifndef __vtkShepardTensor_h
#define __vtkShepardTensor_h

#include "vtkImagingHybridModule.h" // For export macro
#include "vtkImageAlgorithm.h"

class vtkShepardTensor : public vtkImageAlgorithm
{
public:
  vtkTypeMacro(vtkShepardTensor,vtkImageAlgorithm);
  ...
  // Description:
  vtkSetMacro(ProcessAllDataArrays,bool);
  vtkGetMacro(ProcessAllDataArrays,bool);
...
protected:
  ...
  bool UseInputBounds;
  int Dimension;
  bool ProcessAllDataArrays;

private:
  vtkShepardTensor(const vtkShepardTensor&);  // Not implemented.
  void operator=(const vtkShepardTensor&);  // Not implemented.
};
